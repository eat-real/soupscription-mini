...
async function fetchMenu() {
  const url = `https://sheets.googleapis.com/v4/spreadsheets/${SHEETS_ID}/values/menu!A:S?key=${SHEETS_KEY}`;
...
const CATS = [
  { key: "breakfast", icon: "☀️", label: "Breakfast", labelRu: "Завтраки" },
  { key: "soup",      icon: "🍲", label: "Soups",     labelRu: "Супы"     },
  { key: "main",      icon: "🍖", label: "Mains",     labelRu: "Горячее"  },
  { key: "special",   icon: "⭐", label: "Specials",  labelRu: "Спешиалы" },
  { key: "side",      icon: "🍚", label: "Sides",     labelRu: "Гарниры"  },
];

const TR = {
  en: {
    brand_sub: "Mon · Wed · Fri delivery before noon",
    planner: "Planner", menu: "Menu",
    autofill: "⚡ Auto-fill the week", clear: "🗑 Clear",
    autofill_title: "⚡ Auto-fill", autofill_sub: "I'll pick your meals automatically",
    custom: "🎯 Custom", package: "📦 Week Package",
    goal_loss: "👩 Weight loss", goal_maint: "🧘 Maintain", goal_gain: "💪 Muscle gain",
    days_3: "3 days", days_3s: "1 delivery block",
    days_5: "5 days", days_5s: "Mon–Fri",
    days_7: "7 days", days_7s: "Full week",
    fill_btn: "✨ Fill my week →", pkg_btn: "📦 Fill Week Set — 135€ →",
    cancel: "Cancel", no_sides: "No sides →",
    add_sides_title: "🍚 Add sides", add_sides_sub: "pick as many as you like",
    delivery_day: "🚚 Delivery day · Fresh dishes available!",
    tap_place: "Tap to place here →", select_below: "Select a dish below",
    fresh_only: "🚫 Fresh only on delivery day",
    tap_extra: "Tap to add as extra →", add_extra: "Add extras, snacks, desserts…",
    order_btn: "🛒 Order",
    your_order: "Your order", review: "Review before confirming",
    your_details: "📋 Your details", name_lbl: "Name *", contact_lbl: "Phone or Telegram *",
    name_ph: "Your name", contact_ph: "+351 912... or @username",
    confirm: "✅ Confirm order →", edit: "← Edit",
    fill_required: "Please fill in your name and contact",
    free: "🚚 Free!", need_for_free: "need €50 for free",
    total: "Total", order_placed: "Order placed!",
    cooking: "We'll start cooking right away.", notified: "📱 Admin notified via Telegram",
    prev_delivery: "prev delivery", no_delivery: "no delivery",
    cal_goal: "Calorie goal:", how_many_days: "How many days:",
    pkg_title: "📦 Full Week Set", pkg_desc: "5 breakfasts + 5 lunches + 5 dinners\nBalanced nutrition · Free delivery included",
    pkg_fixed: "Fixed price", pkg_delivery: "🚚 Delivery always free with this package",
    menu_title: "Menu", menu_sub: "Updated weekly · Natural ingredients",
    deliver_mode: "Delivery mode:",
    deliver_asap: "🚚 Next delivery", deliver_asap_sub: "All at once",
    deliver_spread: "📅 Spread by days", deliver_spread_sub: "Across the week",
    menu_autofill: "⚡ Auto-fill", menu_clear: "🗑 Clear",
    add_to_order: "Add to order",
    kcal_day: "kcal/day",
  },
  ru: {
    brand_sub: "Доставка Пн · Ср · Пт до обеда",
    planner: "Планер", menu: "Меню",
    autofill: "⚡ Авто-заполнить", clear: "🗑 Очистить",
    autofill_title: "⚡ Авто-заполнение", autofill_sub: "Подберу блюда автоматически",
    custom: "🎯 Свой вариант", package: "📦 Недельный пакет",
    goal_loss: "👩 Похудение", goal_maint: "🧘 Поддержание", goal_gain: "💪 Набор массы",
    days_3: "3 дня", days_3s: "1 блок доставки",
    days_5: "5 дней", days_5s: "Пн–Пт",
    days_7: "7 дней", days_7s: "Вся неделя",
    fill_btn: "✨ Заполнить →", pkg_btn: "📦 Оформить пакет — 135€ →",
    cancel: "Отмена", no_sides: "Без гарнира →",
    add_sides_title: "🍚 Добавить гарниры", add_sides_sub: "можно выбрать несколько",
    delivery_day: "🚚 День доставки · Свежие блюда доступны!",
    tap_place: "Нажми чтобы поставить →", select_below: "Выбери блюдо ниже",
    fresh_only: "🚫 Только в день доставки",
    tap_extra: "Нажми чтобы добавить →", add_extra: "Добавить экстра, перекус…",
    order_btn: "🛒 Заказать",
    your_order: "Ваш заказ", review: "Проверьте перед подтверждением",
    your_details: "📋 Ваши данные", name_lbl: "Имя *", contact_lbl: "Телефон или Telegram *",
    name_ph: "Ваше имя", contact_ph: "+351 912... или @username",
    confirm: "✅ Подтвердить заказ →", edit: "← Изменить",
    fill_required: "Пожалуйста, заполните имя и контакт",
    free: "🚚 Бесплатно!", need_for_free: "нужно до 50€",
    total: "Итого", order_placed: "Заказ принят!",
    cooking: "Уже начинаем готовить.", notified: "📱 Администратор уведомлён в Telegram",
    prev_delivery: "предыдущая доставка", no_delivery: "нет доставки",
    cal_goal: "Цель по калориям:", how_many_days: "На сколько дней:",
    pkg_title: "📦 Недельный набор", pkg_desc: "5 завтраков + 5 обедов + 5 ужинов\nСбалансированное питание · Доставка бесплатно",
    pkg_fixed: "Фиксированная цена", pkg_delivery: "🚚 Доставка всегда бесплатна с этим пакетом",
    menu_title: "Меню", menu_sub: "Обновляется каждую неделю · Натуральные продукты",
    deliver_mode: "Способ доставки:",
    deliver_asap: "🚚 Ближайшая доставка", deliver_asap_sub: "Всё сразу",
    deliver_spread: "📅 По дням недели", deliver_spread_sub: "Размазать равномерно",
    menu_autofill: "⚡ Авто", menu_clear: "🗑 Сброс",
...
function buildWeek() {
  ...
  return Array.from({ length: 7 }, (_, i) => {
    ...
    return {
      ...
      dow,
      isDelivery,
      freshOk: isDelivery,                     // fresh для обеда/ужина: только в день доставки
      freshOkBreakfast: [2,4,6].includes(dow), // fresh для завтрака: Вт, Чт, Сб (день после доставки)
...
function calcDelivery(plan, week) {
  ...
  for (const [date, slots] of Object.entries(plan)) {
    ...
    for (const [sk, v] of Object.entries(slots)) {
      if (sk === "extras") {
        (v || []).forEach(e => { bt[dayToBlock(dow)] += (e?.dish?.price||0) + (((e?.sides||[]).reduce((ss,sd)=>ss+(sd?.price||0),0))); });
      } else if (v) {
...
function formatSummary(plan, week, userName) {
  ...
  for (const day of week) {
    ...
    const kcal  = allE.reduce((s,e)=>s+(e?.dish?.kcal||0)+((e?.sides||[]).reduce((ss,sd)=>ss+(sd?.kcal||0),0)),0);
    const price = allE.reduce((s,e)=>s+(e?.dish?.price||0)+((e?.sides||[]).reduce((ss,sd)=>ss+(sd?.price||0),0)),0);
    foodTotal += price;
    ...
    for (const [sk, v] of filled) {
      if (sk === "extras") {
        (v||[]).forEach(e => {
          const sidePart = ((e?.sides||[]).length>0 ? ` + ${(e.sides).map(s=>s.name).join(', ')}` : "");
          const ePrice = (e.dish?.price||0) + (e?.sides||[]).reduce((s,sd)=>s+(sd?.price||0),0);
          lines.push(`  ★ Extra: ${e.dish?.name}${sidePart} — ${ePrice.toFixed(2)}€`);
        });
      } else {
        const slot = SLOTS.find(s => s.key === sk);
        const sidePart = ((v?.sides||[]).length>0 ? ` + ${(v.sides).map(s=>s.name).join(', ')}` : "");
        const vPrice = (v.dish?.price||0) + (v?.sides||[]).reduce((s,sd)=>s+(sd?.price||0),0);
        lines.push(`  ${slot?.label}: ${v.dish?.name}${sidePart} — ${vPrice.toFixed(2)}€`);
      }
    }
...
/* ══════════════════════════════════════════════════════
   COMPONENTS
══════════════════════════════════════════════════════ */
function MenuPage({ menu, loading, week, onOrderFromMenu, t }) {
  const [cat, setCat]         = useState("breakfast");
  const [cart, setCart]       = useState({}); // { dishId: qty }
  const [deliverMode, setMode] = useState("asap"); // asap | spread

  const items = menu.filter(d => d.cat === cat && d.cat !== "side");
  const totalQty   = Object.values(cart).reduce((s, q) => s + q, 0);
  const totalPrice = Object.entries(cart).reduce((s, [id, q]) => {
    const d = menu.find(d => d.id === id);
    return s + (d?.price || 0) * q;
  }, 0);
  const totalKcal = Object.entries(cart).reduce((s, [id, q]) => {
    const d = menu.find(d => d.id === id);
    return s + (d?.kcal || 0) * q;
  }, 0);
  ...
  const setQtyDirect = (id, val) => {
    ...
    setCart(p => { if (v <= 0) { const n = {...p}; delete n[id]; return n; } return {...p, [id]: v}; });
  };

  const autoFill = () => {
    const cats = ["breakfast","soup","main","special"];
    const newCart = {};
    cats.forEach(c => {
      const available = menu.filter(d => d.cat === c && !d.fresh);
      if (available.length) {
  ...
  const handleOrder = () => {
    ...
    // Превращаем корзину в план
    const newPlan = {};
    const mkEntry = dish => ({ dish, sides: [] });

    if (deliverMode === "asap") {
      // Всё на ближайший день доставки
      const nextDeliv = week.find(d => d.isDelivery);
      if (!nextDeliv) return;
      const dp = { extras: [] };
      ...
      entries.forEach(([id, qty]) => {
        ...
        for (let i = 0; i < qty; i++) {
          if (slotIdx < 3) {
            dp[slotKeys[slotIdx]] = mkEntry(dish);
            slotIdx++;
          } else {
            dp.extras.push(mkEntry(dish));
          }
        }
      });
      newPlan[nextDeliv.key] = dp;
    } else {
      // Размазываем по дням
      const allEntries = entries.flatMap(([id, qty]) => {
        const dish = menu.find(d => d.id === id);
        return Array(qty).fill(dish).filter(Boolean);
      });
      const delivDays = week.filter(d => !d.blocked.has("lunch") && !d.blocked.has("dinner"));
      const perDay = Math.ceil(allEntries.length / delivDays.length);
      let idx = 0;
      delivDays.forEach(day => {
        const dayDishes = allEntries.slice(idx, idx + perDay);
        idx += perDay;
        if (!dayDishes.length) return;
        const dp = { extras: [] };
        const slotKeys = ["breakfast","lunch","dinner"];
        dayDishes.forEach((dish, i) => {
          if (i < 3) dp[slotKeys[i]] = mkEntry(dish);
          else dp.extras.push(mkEntry(dish));
        });
        newPlan[day.key] = dp;
      });
    }
    onOrderFromMenu(newPlan);
  };
  ...
  return (
    <div style={{ paddingBottom: 90 }}>
      {/* Top toolbar */}
      <div style={{ background: "var(--surf)", borderBottom: "1px solid var(--bd)", padding: "10px 14px" }}>
        <div style={{ fontFamily: "Playfair Display,serif", fontSize: 20, marginBottom: 2 }}>{t.menu_title}</div>
        <div style={{ fontSize: 11, color: "var(--ink3)", marginBottom: 10 }}>{t.menu_sub}</div>
        <div style={{ display: "flex", gap: 8, marginBottom: 10 }}>
          <button onClick={autoFill} style={{
            flex: 2, padding: "8px 10px", borderRadius: 10, border: "1.5px dashed var(--gm)",
            background: "var(--gxp)", color: "var(--g)", fontSize: 12, fontWeight: 600,
          }}>{t.menu_autofill}</button>
          <button onClick={() => setCart({})} style={{
            flex: 1, padding: "8px 8px", borderRadius: 10, border: "1.5px solid var(--bd2)",
            background: "var(--surf)", color: "var(--rose)", fontSize: 12, fontWeight: 600,
          }}>{t.menu_clear}</button>
        </div>
        {/* Delivery mode */}
        <div style={{ fontSize: 11, color: "var(--ink2)", fontWeight: 600, marginBottom: 6 }}>{t.deliver_mode}</div>
        <div style={{ display: "flex", gap: 6 }}>
          {[["asap", t.deliver_asap, t.deliver_asap_sub], ["spread", t.deliver_spread, t.deliver_spread_sub]].map(([m, lbl, sub]) => (
            <button key={m} onClick={() => setMode(m)} style={{
              flex: 1, padding: "7px 8px", borderRadius: 10, border: "1.5px solid",
              borderColor: deliverMode === m ? "var(--gm)" : "var(--bd)",
              background: deliverMode === m ? "var(--gxp)" : "var(--surf)",
              fontSize: 11, fontWeight: deliverMode === m ? 700 : 400,
              color: deliverMode === m ? "var(--g)" : "var(--ink2)", textAlign: "left",
            }}>
              <div>{lbl}</div>
              <div style={{ fontSize: 9, opacity: .6, marginTop: 1 }}>{sub}</div>
            </button>
          ))}
        </div>
      </div>
      ...
      <div className="page" style={{ paddingTop: 10 }}>
        ...
        <div style={{ display: "flex", gap: 6, marginBottom: 14, overflowX: "auto" }}>
          {CATS.filter(c => c.key !== "side").map(c => (
            ...
            }}>{c.icon} {t.lang === "ru" ? c.labelRu : c.label}</button>
          ))}
        </div>
        ...
        {items.map((d, i) => {
          ...
          return (
            <div key={d.id} className="mc fu" style={{ animationDelay: `${i * .05}s` }}>
              <div style={{ height: 140, overflow: "hidden", position: "relative", background: "var(--surf2)" }}>
                ...
                {qty > 0 && <div style={{ position: "absolute", top: 6, right: 8, background: "var(--g)", color: "white", fontSize: 11, fontWeight: 700, borderRadius: 20, padding: "2px 10px" }}>×{qty}</div>}
              </div>
              <div className="mc-body">
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                    {qty > 0 && <>
                      <button onClick={() => setQty(d.id, -1)} style={{ width: 28, height: 28, borderRadius: "50%", border: "1.5px solid var(--bd2)", background: "var(--surf2)", fontSize: 16, fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", color: "var(--rose)" }}>−</button>
                      <input type="number" value={qty} min={0} onChange={e => setQtyDirect(d.id, e.target.value)}
                        style={{ width: 36, textAlign: "center", border: "1.5px solid var(--bd)", borderRadius: 8, fontSize: 14, fontWeight: 700, padding: "3px 0", fontFamily: "DM Sans,sans-serif" }} />
                    </>}
                    <button onClick={() => setQty(d.id, 1)} style={{ width: 28, height: 28, borderRadius: "50%", border: "none", background: "var(--g)", fontSize: 18, fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", color: "white" }}>+</button>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Sticky order button */}
      {totalQty > 0 && (
        <div style={{ position: "fixed", bottom: 62, left: 0, right: 0, padding: "10px 14px", background: "var(--surf)", borderTop: "1px solid var(--bd)", zIndex: 50 }}>
          <div style={{ display: "flex", justifyContent: "space-between", fontSize: 11, color: "var(--ink2)", marginBottom: 4 }}>
            <span>{totalQty} dishes · {totalKcal} kcal</span>
            <span style={{ fontWeight: 600, color: "var(--g)" }}>{totalPrice.toFixed(2)}€</span>
          </div>
          <button className="btn btn-g" onClick={handleOrder}>
            {t.order_btn} · {totalPrice.toFixed(2)}€ →
          </button>
        </div>
      )}
    </div>
...
function SidePickerModal({ dish, sides, onSelect, onSkip, t }) {
  const [selected, setSelected] = useState([]);

  const toggle = (side) => {
    setSelected(p =>
      p.find(s => s.id === side.id)
        ? p.filter(s => s.id !== side.id)
        : [...p, side]
    );
  };
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,.5)", zIndex: 200, display: "flex", alignItems: "flex-end" }}>
      <div style={{ background: "var(--surf)", borderRadius: "18px 18px 0 0", padding: "20px 16px 32px", width: "100%" }} className="fu">
        <div style={{ fontFamily: "Playfair Display,serif", fontSize: 18, marginBottom: 2 }}>{t.add_sides_title}</div>
        <div style={{ fontSize: 12, color: "var(--ink3)", marginBottom: 14 }}>to {dish.name} · {t.add_sides_sub}</div>
        <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 14 }}>
          {sides.map(side => {
            const isSel = !!selected.find(s => s.id === side.id);
            return (
              <button key={side.id} onClick={() => toggle(side)} style={{
                padding: "10px 14px", borderRadius: 12,
                border: `1.5px solid ${isSel ? "var(--gm)" : "var(--bd)"}`,
                background: isSel ? "var(--gxp)" : "var(--surf)",
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 11, color: "var(--ink3)", marginTop: 2 }}>
                    {side.kcal} kcal · {side.price}€
                  </div>
                </div>
                <div style={{
                  width: 22, height: 22, borderRadius: 6, flexShrink: 0,
                  border: `2px solid ${isSel ? "var(--gm)" : "var(--bd2)"}`,
                  background: isSel ? "var(--gm)" : "transparent",
                  display: "flex", alignItems: "center", justifyContent: "center",
                }}>
                  {isSel && <span style={{ color: "white", fontSize: 13, fontWeight: 900 }}>✓</span>}
                </div>
              </button>
            );
          })}
        </div>
        <button className="btn btn-g" onClick={() => onSelect(selected)} style={{ marginBottom: 8 }}>
          {selected.length > 0 ? `${t.add_sides_title.split(" ")[1] || "Add"} ${selected.length} →` : t.no_sides}
        </button>
...
function AutoFillModal({ menu, week, onFill, onClose, t }) {
  const [mode, setMode]   = useState("custom");
  const [kcal, setKcal]   = useState(null);
  const [days, setDays]   = useState(null);

  const buildPlan = (targetKcal, daysCount, targetBudget = null) => {
    const breakfasts = menu.filter(d => d.cat === "breakfast" && !d.fresh);
    const soups      = menu.filter(d => (d.cat === "soup" || d.cat === "special") && !d.fresh);
    const mains      = menu.filter(d => (d.cat === "main" || d.cat === "special") && !d.fresh);
    const extrasPool = menu.filter(d => d.cat !== "side" && !d.fresh);
    const shuffle    = arr => [...arr].sort(() => Math.random() - .5);
    const mkEntry = (dish, sides = []) => ({ dish, sides });

    const pickSide = (dish) => {
      const sideIds = dish.sides || [];
      if (!sideIds.length) return [];
      const found = menu.find(s => s.id === sideIds[Math.floor(Math.random() * sideIds.length)]);
      return found ? [found] : [];
    };

    // ── PACKAGE MODE: 5 завтраков Вт-Сб, 5 обедов Пн-Пт, 5 ужинов Пн-Пт ──
    if (targetBudget) {
      const sb = shuffle(breakfasts);
      const ss = shuffle(soups);
      const sm = shuffle(mains);
      const newPlan = {};

      // Завтраки: Вт(dow=2), Ср(3), Чт(4), Пт(5), Сб(6)
      const bfDays  = week.filter(d => [2,3,4,5,6].includes(d.dow));
      // Обеды: Пн(1), Вт(2), Ср(3), Чт(4), Пт(5)
      const lunchDays = week.filter(d => [1,2,3,4,5].includes(d.dow));
      // Ужины: Пн(1), Вт(2), Ср(3), Чт(4), Пт(5)
      const dinnerDays = week.filter(d => [1,2,3,4,5].includes(d.dow));

      // Собираем план по дням
      const allDays = week.filter(d => [1,2,3,4,5,6].includes(d.dow));
      allDays.forEach((day, i) => {
        const dp = {};
        if ([2,3,4,5,6].includes(day.dow) && sb.length) {
          const d = sb[i % sb.length];
          dp.breakfast = mkEntry(d, pickSide(d));
        }
        if ([1,2,3,4,5].includes(day.dow) && ss.length) {
          const d = ss[i % ss.length];
          dp.lunch = mkEntry(d, pickSide(d));
        }
        if ([1,2,3,4,5].includes(day.dow) && sm.length) {
          const d = sm[i % sm.length];
          dp.dinner = mkEntry(d, pickSide(d));
        }
        if (Object.keys(dp).length) newPlan[day.key] = dp;
      });
      return newPlan;
    }
    ...
    const ss = shuffle(soups);
    const sm = shuffle(mains);
    const se = shuffle(extrasPool);
    const newPlan = {};
    let count = 0;

    for (const day of week) {
      if (count >= daysCount) break;
      if (day.dow === 6) continue;
      if (day.blocked.has("lunch") && day.blocked.has("dinner")) continue;
      const dp = {};

      if (!day.blocked.has("breakfast") && sb.length) {
        const d = sb[count % sb.length];
        dp.breakfast = mkEntry(d, pickSide(d));
      }
      if (ss.length) {
        const d = ss[count % ss.length];
        dp.lunch = mkEntry(d, pickSide(d));
      }
      if (sm.length) {
        const d = sm[count % sm.length];
        dp.dinner = mkEntry(d, pickSide(d));
      }

      // Добираем калории через extras — с защитой от зависания
      if (targetKcal > 1600 && se.length) {
        const dayKcal = () => {
          let k = 0;
          if (dp.breakfast) k += dp.breakfast.dish.kcal;
          if (dp.lunch)     k += dp.lunch.dish.kcal + (dp.lunch.sides||[]).reduce((s,sd)=>s+sd.kcal,0);
          if (dp.dinner)    k += dp.dinner.dish.kcal + (dp.dinner.sides||[]).reduce((s,sd)=>s+sd.kcal,0);
          (dp.extras || []).forEach(e => k += (e.dish?.kcal || 0));
          return k;
        };
        const usedIds = new Set([dp.breakfast?.dish?.id, dp.lunch?.dish?.id, dp.dinner?.dish?.id].filter(Boolean));
        const candidates = se.filter(d => !usedIds.has(d.id));
        let ci = 0;
        while (dayKcal() < targetKcal - 200 && ci < candidates.length && (dp.extras||[]).length < 3) {
          dp.extras = [...(dp.extras || []), mkEntry(candidates[ci])];
          ci++;
        }
      }
  ...
  const handleFill = () => {
    if (mode === "package") {
      onFill(buildPlan(2000, 5, 135));
    } else {
      if (!kcal || !days) return;
      onFill(buildPlan(kcal, days, null));
    }
    onClose();
  };
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,.5)", zIndex: 200, display: "flex", alignItems: "flex-end" }}>
      <div style={{ background: "var(--surf)", borderRadius: "18px 18px 0 0", padding: "20px 16px 32px", width: "100%", maxHeight: "90vh", overflowY: "auto" }} className="fu">
        <div style={{ fontFamily: "Playfair Display,serif", fontSize: 20, marginBottom: 4 }}>{t.autofill_title}</div>
        <div style={{ fontSize: 12, color: "var(--ink3)", marginBottom: 16 }}>{t.autofill_sub}</div>

        {/* Mode toggle */}
        <div style={{ display: "flex", gap: 2, background: "var(--surf2)", borderRadius: 10, padding: 3, marginBottom: 16 }}>
          {[["custom", t.custom], ["package", t.package]].map(([m, l]) => (
            <button key={m} onClick={() => setMode(m)} style={{
              flex: 1, padding: "8px 4px", borderRadius: 8, border: "none",
              background: mode === m ? "var(--surf)" : "transparent",
              color: mode === m ? "var(--g)" : "var(--ink2)",
        ...
        {mode === "package" ? (
          /* 135€ Package */
          <div style={{ background: "linear-gradient(135deg,#192b16,#2a5c24)", borderRadius: 14, padding: "16px", marginBottom: 16, color: "white" }}>
            <div style={{ fontFamily: "Playfair Display,serif", fontSize: 22, fontWeight: 700, marginBottom: 6 }}>{t.pkg_title}</div>
            <div style={{ fontSize: 13, opacity: .85, lineHeight: 1.6, marginBottom: 12, whiteSpace: "pre-line" }}>
              {t.pkg_desc}
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", background: "rgba(255,255,255,.12)", borderRadius: 10, padding: "10px 14px" }}>
              <span style={{ fontSize: 13, fontWeight: 600 }}>{t.pkg_fixed}</span>
              <span style={{ fontFamily: "Playfair Display,serif", fontSize: 26, fontWeight: 700 }}>135€</span>
            </div>
          ...
          /* Custom mode */
          <>
            <div style={{ fontSize: 12, fontWeight: 600, color: "var(--ink2)", marginBottom: 8 }}>{t.cal_goal}</div>
            <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 16 }}>
              {[[1400, t.goal_loss, "~1400 kcal/day"], [2000, t.goal_maint, "~2000 kcal/day"], [2500, t.goal_gain, "~2500 kcal/day"]].map(([val, lbl, sub]) => (
                <button key={val} onClick={() => setKcal(val)} style={{
                  padding: "10px 14px", borderRadius: 12, border: "1.5px solid",
                  borderColor: kcal === val ? "var(--gm)" : "var(--bd)",
                  background: kcal === val ? "var(--gxp)" : "var(--surf)",
            ...
            <div style={{ fontSize: 12, fontWeight: 600, color: "var(--ink2)", marginBottom: 8 }}>{t.how_many_days}</div>
            <div style={{ display: "flex", gap: 8, marginBottom: 20 }}>
              {[[3, t.days_3, t.days_3s], [5, t.days_5, t.days_5s], [7, t.days_7, t.days_7s]].map(([val, lbl, sub]) => (
                <button key={val} onClick={() => setDays(val)} style={{
                  flex: 1, padding: "10px 8px", borderRadius: 12, border: "1.5px solid",
                  borderColor: days === val ? "var(--gm)" : "var(--bd)",
                  background: days === val ? "var(--gxp)" : "var(--surf)",
                  fontWeight: 600, fontSize: 12,
                }}>
                  {lbl}<br/>
                  <span style={{ fontSize: 10, color: "var(--ink3)", fontWeight: 400 }}>{sub}</span>
                </button>
              ))}
            </div>
          </>
        ...
        <button className="btn btn-g" onClick={handleFill}
          disabled={mode === "custom" && (!kcal || !days)}
          style={{ opacity: mode === "custom" && (!kcal || !days) ? .5 : 1, marginBottom: 10 }}>
          {mode === "package" ? t.pkg_btn : t.fill_btn}
        </button>
        <button className="btn btn-out" style={{ width: "100%", justifyContent: "center" }} onClick={onClose}>{t.cancel}</button>
      </div>
    </div>
  );
}

function PlannerPage({ menu, week, plan, setPlan, onCheckout, t }) {
  ...
  const sides   = menu; // любое блюдо может быть гарниром
  const catItems = menu.filter(d => {
    if (!d.fresh) return d.cat === activeCat;
    if (activeCat !== d.cat) return false;
    // fresh блюда: для завтрака проверяем freshOkBreakfast, для остальных - freshOk
    return activeCat === "breakfast" ? day?.freshOkBreakfast : day?.freshOk;
  });

  const commitSlot = (sk, dish, sides = []) => {
    const entry = { dish, sides };
    if (sk === "extras") {
      setPlan(p => {
  ...
  const placeInSlot = (sk) => {
    ...
    // Fresh логика: для завтрака — Вт/Чт/Сб, для обеда/ужина — день доставки
    const freshAllowed = sk === "breakfast" ? day.freshOkBreakfast : day.freshOk;
    if (selected.fresh && !freshAllowed) return;
  ...
  // Считаем цену и ккал из entry { dish, sides: [] }
  const sidesKcal  = e => (e?.sides || []).reduce((s,sd) => s + (sd?.kcal||0), 0);
  const sidesPrice = e => (e?.sides || []).reduce((s,sd) => s + (sd?.price||0), 0);
  const entryKcal  = e => (e?.dish?.kcal || 0) + sidesKcal(e);
  const entryPrice = e => (e?.dish?.price || 0) + sidesPrice(e);
  const entryName  = e => {
    const sideNames = (e?.sides || []).map(s => s.name).join(", ");
    return sideNames ? `${e?.dish?.name} + ${sideNames}` : (e?.dish?.name || "");
  };
  ...
  return (
    <div className="page">
      ...
      {(() => {
        ...
        const kcal = allE.reduce((s,e)=>s+(e?.dish?.kcal||0)+((e?.sides||[]).reduce((ss,sd)=>ss+(sd?.kcal||0),0)),0);
        const p    = allE.reduce((s,e)=>s+(e?.dish?.p||0)+((e?.sides||[]).reduce((ss,sd)=>ss+(sd?.p||0),0)),0);
        const f    = allE.reduce((s,e)=>s+(e?.dish?.f||0)+((e?.sides||[]).reduce((ss,sd)=>ss+(sd?.f||0),0)),0);
        const c    = allE.reduce((s,e)=>s+(e?.dish?.c||0)+((e?.sides||[]).reduce((ss,sd)=>ss+(sd?.c||0),0)),0);
      ...
      {SLOTS.map(slot => {
        ...
        const freshAllowed = slot.key === "breakfast" ? day?.freshOkBreakfast : day?.freshOk;
        const isAvail = !blocked && selected && !entry && !(selected.fresh && !freshAllowed);
        return (
          <div key={slot.key} className={`slot-card${isAvail ? " avl" : ""}${entry ? " fld" : ""}${blocked ? " blk" : ""}`}
            ...
            <div className="slot-content">
              {blocked ? (
                <span style={{ fontSize: 11, color: "var(--ink3)" }}>— {day?.isDelivery ? t.prev_delivery : t.no_delivery}</span>
              ) : entry ? (
                <>
                ...
                <span style={{ fontSize: 12, color: "var(--g)", fontWeight: 600 }}>{t.tap_place}</span>
              ) : (
                <span style={{ fontSize: 12, color: "var(--ink3)" }}>
                  {selected && selected.fresh && !freshAllowed ? t.fresh_only : t.select_below}
                </span>
              )}
            </div>
          </div>
      ...
      <div style={{ borderRadius: "var(--r)", border: "1.5px dashed var(--bd)", background: selected ? "var(--gxp)" : "var(--surf)", marginBottom: 8, overflow: "hidden", transition: "all .13s" }}
        ...
        <div style={{ padding: "8px 10px", display: "flex", alignItems: "center", gap: 8, borderBottom: (dayPlan.extras?.length > 0) ? "1px solid var(--bd)" : "none" }}>
          ...
          <span style={{ fontSize: 12, color: selected ? "var(--g)" : "var(--ink3)", fontWeight: selected ? 600 : 400 }}>
            {selected ? t.tap_extra : t.add_extra}
          </span>
        </div>
        {(dayPlan.extras || []).map((e, i) => (
          <div key={i} style={{ display: "flex", alignItems: "center", gap: 8, padding: "6px 10px", borderBottom: i < (dayPlan.extras.length - 1) ? "1px solid var(--surf2)" : "none" }}>
            <div style={{ flex: 1, fontSize: 12, fontWeight: 600 }}>
              {e.dish?.name}{(e.sides||[]).length > 0 ? ` + ${(e.sides||[]).map(s=>s.name).join(", ")}` : ""}
            </div>
      ...
      {hasAny && (
        <button className="btn btn-g" onClick={onCheckout} style={{ marginTop: 4 }}>
          {t.order_btn} · {(foodTotal + fee).toFixed(2)}€ →
        </button>
      )}

      {showAuto && <AutoFillModal menu={menu} week={week} onFill={p => setPlan(p)} onClose={() => setShowAuto(false)} t={t} />}
      {sidePicker && <SidePickerModal dish={sidePicker.dish} sides={sidePicker.sides}
        onSelect={sides => commitSlot(sidePicker.slotKey, sidePicker.dish, sides)}
        onSkip={() => commitSlot(sidePicker.slotKey, sidePicker.dish, [])} t={t} />}
    </div>
  );
}

function SummaryPage({ plan, week, onBack, onConfirm, sending, t }) {
  const tgName = TG_USER ? `${TG_USER.first_name || ""} ${TG_USER.last_name || ""}`.trim() : "";
  const [name,    setName]    = useState(tgName);
  const [contact, setContact] = useState("");
  const { fee, bt } = calcDelivery(plan, week);
  const BNAMES = [t.lang==="ru" ? "Блок Пн" : "Mon delivery block", t.lang==="ru" ? "Блок Ср" : "Wed delivery block", t.lang==="ru" ? "Блок Пт" : "Fri delivery block"];

  const entryPrice = e => (e?.dish?.price || 0) + (e?.sides || []).reduce((s, sd) => s + (sd?.price || 0), 0);
  const entryKcal  = e => (e?.dish?.kcal  || 0) + (e?.sides || []).reduce((s, sd) => s + (sd?.kcal  || 0), 0);
  const entryP     = e => (e?.dish?.p     || 0) + (e?.sides || []).reduce((s, sd) => s + (sd?.p     || 0), 0);
  const entryF     = e => (e?.dish?.f     || 0) + (e?.sides || []).reduce((s, sd) => s + (sd?.f     || 0), 0);
  const entryC     = e => (e?.dish?.c     || 0) + (e?.sides || []).reduce((s, sd) => s + (sd?.c     || 0), 0);
  ...
  return (
    <div className="page">
      <div style={{ fontFamily: "Playfair Display,serif", fontSize: 22, marginBottom: 4 }}>{t.your_order}</div>
      <div style={{ fontSize: 12, color: "var(--ink3)", marginBottom: 16 }}>{t.review}</div>

      {/* Contact form */}
      <div style={{ background: "var(--surf)", borderRadius: "var(--r)", border: "1.5px solid var(--bd)", padding: "12px 14px", marginBottom: 14 }}>
        <div style={{ fontSize: 13, fontWeight: 700, marginBottom: 10 }}>{t.your_details}</div>
        <div style={{ marginBottom: 8 }}>
          <div style={{ fontSize: 11, color: "var(--ink2)", marginBottom: 4, fontWeight: 600 }}>{t.name_lbl}</div>
        ...
        <div>
          <div style={{ fontSize: 11, color: "var(--ink2)", marginBottom: 4, fontWeight: 600 }}>{t.contact_lbl}</div>
          <input value={contact} onChange={e => setContact(e.target.value)} placeholder={t.contact_ph}
            style={{ width: "100%", padding: "9px 12px", borderRadius: 10, border: "1.5px solid var(--bd)", fontSize: 13, outline: "none", fontFamily: "DM Sans,sans-serif" }} />
        </div>
      </div>

      {/* Order lines with per-day KBJU */}
      {week.filter(d => {
        const dp = plan[d.key] || {};
        ...
        const filled = Object.entries(dp).filter(([k, v]) => k === "extras" ? v?.length > 0 : !!v);
        const allE = filled.flatMap(([k, v]) => k === "extras" ? (v||[]) : [v]);
        const kcal = allE.reduce((s,e)=>s+entryKcal(e),0);
        const p    = allE.reduce((s,e)=>s+entryP(e),0);
        const f    = allE.reduce((s,e)=>s+entryF(e),0);
        const c    = allE.reduce((s,e)=>s+entryC(e),0);
        const price= allE.reduce((s,e)=>s+entryPrice(e),0);
        const pct  = Math.min(100, Math.round(kcal/2000*100));
        const bc   = pct > 105 ? "var(--rose)" : pct >= 70 ? "var(--gm)" : "var(--a)";
        return (
          <div key={day.key} className="sum-day fu">
            <div className="sum-day-hdr">
              ...
              <span className="sum-day-kcal">{price.toFixed(2)}€</span>
            </div>
            {/* КБЖУ строка */}
            <div style={{ marginBottom: 6 }}>
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: 11, marginBottom: 3 }}>
                <span style={{ fontWeight: 700, color: bc }}>{kcal} kcal</span>
                <span style={{ color: "var(--ink3)" }}>P{p}g · F{f}g · C{c}g</span>
              </div>
              ...
              <div style={{ fontSize: 9, color: "var(--ink3)", marginTop: 2 }}>{pct}% of 2000 {t.kcal_day}</div>
            </div>
            {filled.map(([sk, v]) => {
              if (sk === "extras") return (v || []).map((e, i) => (
                <div key={`ex${i}`} className="sum-slot">
                  ...
                  <span style={{ fontWeight: 600 }}>
                    {e.dish?.name}{((e?.sides||[]).length>0 ? ` + ${(e.sides).map(s=>s.name).join(', ')}` : "")}
                    <span style={{ color: "var(--a)" }}> {((e.dish?.price||0)+(e?.sides||[]).reduce((s,sd)=>s+(sd?.price||0),0)).toFixed(2)}€</span>
                  </span>
                </div>
              ));
              const slot = SLOTS.find(s => s.key === sk);
              return (
                <div key={sk} className="sum-slot">
                  ...
                  <span style={{ fontWeight: 600 }}>
                    {v.dish?.name}{((v?.sides||[]).length>0 ? ` + ${(v.sides).map(s=>s.name).join(', ')}` : "")}
                    <span style={{ color: "var(--a)" }}> {((v.dish?.price||0)+(v?.sides||[]).reduce((s,sd)=>s+(sd?.price||0),0)).toFixed(2)}€</span>
                  </span>
                </div>
              );
            })}
        ...
        {Object.entries(bt).map(([bi, bv]) => bv > 0 && (
          <div key={bi} className={`del-block ${bv >= FREE_THRESHOLD ? "free" : "paid"}`}>
            <div>
              ...
              {bv < FREE_THRESHOLD && <div style={{ fontSize: 10, color: "var(--a)", marginTop: 2 }}>{bv.toFixed(2)}€ / {t.need_for_free}</div>}
            </div>
            <span style={{ fontSize: 13, fontWeight: 700, color: bv >= FREE_THRESHOLD ? "var(--g)" : "var(--a)" }}>
              {bv >= FREE_THRESHOLD ? t.free : `+${DELIVERY_FEE}€`}
            </span>
          </div>
        ))}
      </div>
      ...
      <button className="btn btn-g" onClick={() => canConfirm && onConfirm(name, contact)}
        ...
        {sending ? <span className="spinner" /> : t.confirm}
      </button>
      {!canConfirm && <div style={{ textAlign: "center", fontSize: 11, color: "var(--rose)", marginBottom: 8 }}>{t.fill_required}</div>}
      <button className="btn btn-out" style={{ width: "100%", justifyContent: "center" }} onClick={onBack}>{t.edit}</button>
    </div>
  );
}

function SuccessPage({ total, t }) {
  useEffect(() => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "60vh", padding: 24, textAlign: "center" }}>
      ...
      <h2 style={{ fontSize: 26, marginBottom: 8 }}>{t.order_placed}</h2>
...
export default function App() {
  ...
  const handleOrderFromMenu = (newPlan) => {
    setPlan(newPlan);
    setTab("planner");
    setPage("summary");
  };
  ...
  const LangToggle = () => (
    <select value={lang} onChange={e => setLang(e.target.value)} style={{
      ...
      borderRadius: 8, padding: "4px 8px", color: "white", fontSize: 12,
      fontWeight: 600, cursor: "pointer", outline: "none", fontFamily: "DM Sans,sans-serif",
    }}>
      <option value="" disabled>Language</option>
      <option value="en" style={{ color: "var(--ink)", background: "white" }}>🇬🇧 English</option>
      <option value="ru" style={{ color: "var(--ink)", background: "white" }}>🇷🇺 Русский</option>
    </select>
  );
  ...
  if (page === "success") return (
    <>
      <style>{CSS}</style>
      <div className="hdr"><div><div className="hdr-logo">🥣 SoupScription</div></div></div>
      <SuccessPage total={orderTotal} t={t} />
    </>
  );
  ...
  if (page === "summary") return (
    <>
      <style>{CSS}</style>
      <div className="hdr">
        <div><div className="hdr-logo">🥣 SoupScription</div><div className="hdr-sub">{t.brand_sub}</div></div>
        <LangToggle />
      </div>
      <SummaryPage plan={plan} week={week} onBack={() => setPage("main")} onConfirm={handleConfirm} sending={sending} t={t} />
    </>
  );
    ...
    <>
      ...
      <div className="hdr">
        <div>
          ...
          <div className="hdr-sub">{t.brand_sub}</div>
        </div>
      ...
      {tab === "planner" && (
        <PlannerPage menu={menu} week={week} plan={plan} setPlan={setPlan}
          onCheckout={() => setPage("summary")} t={t} />
      )}
      {tab === "menu" && (
        <MenuPage menu={menu} loading={loading} week={week} onOrderFromMenu={handleOrderFromMenu} t={t} />
      )}

      <nav className="bbar">
        <button className={`bbar-btn${tab === "planner" ? " on" : ""}`} onClick={() => setTab("planner")}>
          <span className="bbar-icon">📅</span>{t.planner}
        </button>
        <button className={`bbar-btn${tab === "menu" ? " on" : ""}`} onClick={() => setTab("menu")}>
          <span className="bbar-icon">🍽️</span>{t.menu}
        </button>
      </nav>
    </>
  );
